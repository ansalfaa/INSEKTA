<header class="bg-white border-b border-amber-100">
    <div class="max-w-6xl mx-auto flex justify-between items-center h-16 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="flex items-center space-x-3">
                <img src="{{ asset('images/insekgam.png') }}" 
                     alt="Logo" 
                ...
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6 
                             6 0 10-12 0v3.159c0 .538-.214 1.055-.595 
