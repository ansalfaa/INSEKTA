<aside id="sidebar-left"
    class="transform -translate-x-full transition-transform duration-300 ease-in-out w-64 flex-shrink-0 flex-col bg-dark-amber text-white z-50 fixed inset-y-0 left-0 md:relative md:flex md:translate-x-0">

    {{-- Logo --}}
    <div class="w-full flex justify-center items-center p-12 border-b border-primary-amber">
        <img src="{{ asset('images/logoputih.png') }}" alt="Logo Insekta"
            class="w-full max-w-[160px] h-auto object-contain" />
    </div>

    {{-- Navigasi --}}
    <nav class="flex-1 overflow-auto p-6">
        <div class="text-xs font-bold mb-2 uppercase text-primary-amber">Navigasi</div>
        <ul class="space-y-1">
            ...
            <li>
                <a href="{{ route('siswa.pages.notifikasi') }}"
                    ...
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" stroke-width="2"
                        viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6 6 0 00-12 0v3.159c0 .538-.214 1.055-.595 1.436L4 17h16z" />
                    </svg>
            ...
            <li>
                <a href="{{ route('siswa.pages.pesan') }}"
                    ...
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" stroke-width="2"
                        viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M21 8.25v8.25a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 16.5V8.25M21 8.25l-9 5.25L3 8.25M21 8.25L12 3 3 8.25" />
                    </svg>
                    <span>Pesan</span>
                </a>
            </li>
        ...
        <div class="border-t border-primary-amber mt-4 pt-4">
            <div class="text-xs font-bold mb-2 uppercase text-primary-amber">Aksi Cepat</div>
            <ul class="space-y-1">
                <li>
                    <a href="#buat"
                        class="flex items-center px-4 py-2 rounded-md transition duration-200 hover:bg-accent-amber text-white">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
