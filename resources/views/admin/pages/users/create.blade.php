<div class="p-4 sm:p-6 lg:p-8 max-w-3xl mx-auto h-screen">
    <!-- Form Card -->
    <div class="bg-white rounded-xl shadow-lg flex flex-col h-full">
        ...
        <div class="flex-1 overflow-y-auto">
            <form action="{{ route('admin.users.store') }}" method="POST" class="p-4 sm:p-6 space-y-4">
                @csrf
                <!-- Nama Lengkap -->
                <div class="mb-4">
                ...
                <div id="guru-fields" class="hidden">
                    <div class="mb-4">
                        <label class="flex items-center text-sm font-semibold text-gray-700 mb-2">
                            <i class="fas fa-id-badge text-primary-amber mr-2"></i>
                            NIP
                        </label>
                    ...
                    <div class="mb-4">
                        <label class="flex items-center text-sm font-semibold text-gray-700 mb-2">
                            <i class="fas fa-book text-primary-amber mr-2"></i>
                            Mata Pelajaran
                        </label>
                ...
                <div id="siswa-fields" class="hidden">
                    <div class="mb-4">
                        <label class="flex items-center text-sm font-semibold text-gray-700 mb-2">
                            <i class="fas fa-id-card-alt text-primary-amber mr-2"></i>
                            NIS
                        </label>
                    ...
                    <div class="mb-4">
                        <label class="flex items-center text-sm font-semibold text-gray-700 mb-2">
                            <i class="fas fa-school text-primary-amber mr-2"></i>
                            Kelas
                        </label>
                    ...
                    <div class="mb-4">
                        <label class="flex items-center text-sm font-semibold text-gray-700 mb-2">
                            <i class="fas fa-code-branch text-primary-amber mr-2"></i>
                            Jurusan
                        </label>
