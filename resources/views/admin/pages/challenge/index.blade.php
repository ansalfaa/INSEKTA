                            ...
                            @foreach ($challenges as $index => $challenge)
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center">
                                            <div
                                                class="w-8 h-8 bg-primary-amber rounded-lg flex items-center justify-center mr-3">
                    ...
                    @foreach ($challenges as $index => $challenge)
                        <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex items-center">
                                    <div
                                        class="w-10 h-10 bg-primary-amber rounded-lg flex items-center justify-center mr-3">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex space-x-1">
                                    ...
                                    <form action="{{ route('admin.challenge.destroy', $challenge->id) }}" method="POST"
                                        class="inline" onsubmit="return confirm('Yakin ingin menghapus challenge ini?')">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                                            class="p-1.5 bg-red-500 text-white rounded-md hover:bg-red-600 transition-colors duration-200">
